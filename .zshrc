...
plugins=(vi-mode tig git github extract archlinux python perl svn encode64 perl urltools systemd catimg docker docker-compose kubectl ansible oc zsh-navigation-tools)
